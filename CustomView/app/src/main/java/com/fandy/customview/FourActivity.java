...
import com.fandy.customview.custom.PinnedHeaderExpandableListView;
import com.fandy.customview.custom.StickyLayout;
import com.fandy.customview.domain.Group;
import com.fandy.customview.domain.People;

import java.util.ArrayList;
import java.util.List;

public class FourActivity extends Activity implements
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(FourActivity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
